...
const Registrar = () => {
    ...
    const handleSubmit = async e => {
        ...
        if (password.length < 6) {
            setAlerta({ msg: "El password debe ser mayor de 6 caracteres", error: true});
            return;
        }
        setAlerta({})
    ...
    <>
        <div>
            <h1 className="text-indigo-600 font-black text-6xl md:mt-24">
        ...
        <div className="mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white">
            ...
            <form onSubmit={handleSubmit} >
                ...
                <div className="my-5">
                    ...
                    <input className="border w-full p-3 mt-3 bg-gray-50 rounded-xl" type="password" placeholder="Repetir tu Password" value={repetirPassword} onChange={e => setRepetirPassword(e.target.value)}/>
                </div>
                ...
                <Link className="block text-center my-5 text-gray-500 hover:text-gray-900" to="/">¿Ya tienes una cuenta? Inicia Sesión</Link>
                <Link className="block text-center my-5 text-gray-500 hover:text-gray-900" to="/olvide-password">Olvide mi password</Link>
            </nav>
            </form>
        </div>
    </>
